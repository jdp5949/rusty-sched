...
-- A "resource" is a counter with a fixed capacity. Jobs claim N units;
-- the scheduler skips a job when claims exceed remaining capacity.
...
ALTER TABLE jobs ADD COLUMN resource_claims_json TEXT;
